...
def form(request):
    ...
    if request.method == 'POST':
            ...
            if name !="" and dob!=""  and age!="" and gender!="" and phone!="" and mail!="" and address!="" and material!="":
                form_detail = Student(name=name, dob=dob, age=age, gender=gender, phone=phone, mail=mail, address=address,
